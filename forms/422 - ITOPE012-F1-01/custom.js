...
const vm = new Vue({
  ...
  data(){ 
    return {
	  ...
	  model: {
		  itemsPrincipal: [{}],
		  itemsPruebaAdherencia: [{'nomrow':'Prueba de Adherencia'}],
		  itemsResonsables: [],
  ...
  computed: {
	    headersPrincipal() {
	    	return [
	    	        { text: 'Control del Lote', align: 'center', value: 'controlLote', type: 'input', width: '10rem', sortable: false, divider: true },
	    	        { text: 'Junta', align: 'center', value: 'junta', type: 'input', width: '10rem', inputType: 'text', sortable: false, divider: true },           
	    	        { text: 'Temperatura Superficie p/ Aplicación del Primer (C°)', align: 'center', value: 'temperatura', type: 'input', width: '10rem', inputType: 'text', sortable: false, divider: true },           
	    	        { text: 'Preparación Superficie', align: 'center', value: 'preparacionSuperficie', type: 'input', width: '10rem', inputType: 'text', sortable: false},           
	    	        { text: 'Aplicación Primer', align: 'center', value: 'aplicacionPrimer', type: 'input', width: '10rem', inputType: 'text', sortable: false},           
	    	        { text: 'Manta Aplicada', align: 'center', value: 'mantaAplicada', type: 'input', width: '10rem', inputType: 'text', sortable: false, divider: true },           
	    	        { text: 'Inspección Holliday Detector', align: 'center', value: 'inspeccionHolliday', type: 'input', width: '10rem', inputType: 'text', sortable: false, divider: true },           
	    	        { text: 'Resultado Final', align: 'center', value: 'resultadoFinal', type: 'input', width: '10rem', inputType: 'text', sortable: false, divider: true },           
	    	        { text: 'Observaciones', align: 'center', value: 'observaciones', type: 'input', width: '20rem', inputType: 'text', sortable: false }, 
	    	        { text: '', align: 'center', value: 'deleteRow', type: 'icon', width: '2rem', sortable: false},
    	           ];
	    },
	    headersPruebaAdherencia() {
	    	return [
	    	        { text: '', align: 'center', value: 'nomrow', width: '10rem', sortable: false},
	    	        { text: 'Junta', align: 'center', value: 'juntaPA', type: 'input', width: '10rem', inputType: 'text', sortable: false, divider: true },          
	    	        { text: 'Temp. Superficie (C°)', align: 'center', value: 'tempSuperficiePA', type: 'input', width: '10rem', inputType: 'text', sortable: false, divider: true },          
	    	        { text: 'Longitud Desprendida (mm) A', align: 'center', value: 'longitudDesprendidaAPA', type: 'input', width: '15rem', inputType: 'text', sortable: false },          
	    	        { text: 'Tiempo (s) A', align: 'center', value: 'tiempoAPA', type: 'input', width: '15rem', inputType: 'text', sortable: false, divider: true },          
	    	        { text: 'Longitud Desprendida (mm) B', align: 'center', value: 'longitudDesprendidaBPA', type: 'input', width: '15rem', inputType: 'text', sortable: false },          
	    	        { text: 'Tiempo (s) B', align: 'center', value: 'tiempoBPA', type: 'input', width: '15rem', inputType: 'text', sortable: false, divider: true },          
	    	        { text: 'Resultado', align: 'center', value: 'resultadoPA', type: 'input', width: '20rem', inputType: 'text', sortable: false },          
    	           ];
	    },
	    headersResponsables() {
		      return [
		              { text: '', align: 'center', value: 'nomrow', sortable: false },
		              { text: 'Jefe de Fase', align: 'center', value: 'jefeDeFase', type: 'input', inputType: 'text', sortable: false},
		              { text: 'Supervisor de Calidad', align: 'center', value: 'supervisorCalidad', type: 'input', inputType: 'text', sortable: false },
		              { text: 'Inspección Cliente', align: 'center', value: 'inpeccionCliente', type: 'input', inputType: 'text', sortable: false},
		      ];
		},
		codObra(){
  ...
  methods: {	
	  init() {
		...
		this.verificaTareaActual(6, 8) //Revisar número de tarea en proceso (Tarea Aprobación, Tarea final)
		
//	   	if(this.WKNumState == 4){
//	     this.viewMode = true
//		}
	  },
	  loadModel(){
     ...
     cargaDatosDinamicos(){
    	 ...
    	 if (this.model.itemsResonsables.length == 0) {
        	 this.model.itemsResonsables.push(
        			 {'nomrow':'Firma y Aclaración', 'jefeDeFase': this.nombreUsuario}, {'nomrow':'Fecha', 'jefeDeFase': fechaDelDia()}
        	 )  
    	 }
     }
  }
...
//------------------------------------------------------------------------
encabezadoConTitulo('Preparación Superficie', '', 'Prep. Superficie')
encabezadoConTitulo('Aplicación Primer', 'Inspección Visual', 'Aplicación Primer')
encabezadoConTitulo('Manta Aplicada', '', 'Manta Aplicada')

encabezadoConTitulo('Longitud Desprendida (mm) A', 'Revestimiento - Tubo', 'Longitud Desprendida (mm)')
encabezadoConTitulo('Tiempo (s) A', '', 'Tiempo (s)')
encabezadoConTitulo('Longitud Desprendida (mm) B', 'Revestimiento - Mantas', 'Longitud Desprendida (mm)')
encabezadoConTitulo('Tiempo (s) B', '', 'Tiempo (s)')