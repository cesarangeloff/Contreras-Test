Vue.component('fincargacli', {
    ...
    <v-card class="pa-4" outlined>
		...
		<div class="mb-4">
		  ...
		  <p><strong>Paso 3:</strong> Cargue los datos impositivos necesarios para el cliente: {{ razsoc }}</p>
		  <p><strong>Paso 4:</strong> Una vez completado, se deberá seleccionar el cliente en el formulario para poder continuar con la cotización</p>
